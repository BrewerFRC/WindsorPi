...
class Controller:
    ...
    # Get the value of the digital pin
    # Note: Only use on DIO Channels
    def getDIO(self, getPortNum):
        if self.getPosition(getPortNum) >= 512:
            return True
        else:
            return False

"""
    # Set the port to PWM, Digital-In, or Digital-Out
    def setPort(self, portNum, portType)
        ## 0 - PWM
        ## 1 - Digital-In
        ## 2 - Digital-Out
        if portType == 0
            ...
            print "ERROR: INVALID PORT SETTING"


    def setDIO(self, setPortNum, DIO_Value)
"""        
